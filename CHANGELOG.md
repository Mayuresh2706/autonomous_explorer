...
| Author | Commits | Contributions | Primary Role |
|--------|---------|---------------|--------------|
| Mayuresh2706 | 10 | 71.4% | Core algorithm, WFD, exploration logic |
| Yeo Chen Xian | 4 | 28.6% | Integration, marker detection, testing |
